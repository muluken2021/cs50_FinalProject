      ...
      <div className="max-w-[440px] w-full space-y-8">
        ...
        <div className="text-left space-y-2">
          ...
          <p className="text-slate-500 font-medium">
            Don’t have an account? <a href="#" className="text-[#10b981] hover:underline">Get started</a>
          </p>
        </div>
        ...
        <form className="space-y-5">
          ...
          <div className="relative">
            ...
            <input
              type="email"
              className="w-full h-14 px-5 border border-gray-200 rounded-xl text-slate-900 focus:border-slate-900 focus:outline-none transition-colors"
            />
          </div>
          ...
          <div className="space-y-2">
            <div className="flex justify-end">
              <a href="#" className="text-sm font-bold text-slate-900 hover:opacity-70">Forgot password?</a>
            </div>
            <div className="relative">
              <div className="absolute -top-3 left-4 px-2 bg-white z-10">
